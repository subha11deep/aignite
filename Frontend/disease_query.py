...
#     st.markdown("<h1 style='text-align: center;'>Disease Query Assistant</h1>", unsafe_allow_html=True)
#     st.markdown(
#         "<p style='text-align: center;'>Welcome to the Disease Query Assistant. You can ask questions about symptoms, "
...
#             try:
#                 # Example API call (replace with your actual API URL and payload)
#                 # api_url = "https://example.com/api/disease_query"  # Replace with your API endpoint
#                 # payload = {"query": user_input}
#                 # response = requests.post(api_url, json=payload)
#                 # response_data = response.json()

#                 # # Extract the API response (adjust based on your API's response format)
#                 # backend_response = response_data.get("response", "Sorry, I couldn't process your request.")
